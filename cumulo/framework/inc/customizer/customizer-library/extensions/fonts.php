...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'cumulo' ),
		'cyrillic'     => __( 'Cyrillic', 'cumulo' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'cumulo' ),
		'devanagari'   => __( 'Devanagari', 'cumulo' ),
		'greek'        => __( 'Greek', 'cumulo' ),
		'greek-ext'    => __( 'Greek Extended', 'cumulo' ),
		'khmer'        => __( 'Khmer', 'cumulo' ),
		'latin'        => __( 'Latin', 'cumulo' ),
		'latin-ext'    => __( 'Latin Extended', 'cumulo' ),
		'vietnamese'   => __( 'Vietnamese', 'cumulo' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'cumulo' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'cumulo' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'cumulo' ),
