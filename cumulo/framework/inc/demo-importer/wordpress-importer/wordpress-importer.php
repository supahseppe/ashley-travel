...
<?php
	...
	function process_menu_item( $item ) {
		...
		if ( $id && ! is_wp_error( $id ) ) {
			...
			if( !empty( $GLOBALS['menu-item-cmo_enable_megamenu'] ) ) {
				update_post_meta( $id, 'menu-item-cmo_enable_megamenu', $GLOBALS['menu-item-cmo_enable_megamenu'] );
				unset( $GLOBALS['menu-item-cmo_enable_megamenu'] );
			}
			if( !empty( $GLOBALS['menu-item-cmo_fa_icons'] ) ) {
				update_post_meta( $id, 'menu-item-cmo_fa_icons', $GLOBALS['menu-item-cmo_fa_icons'] );
				unset( $GLOBALS['menu-item-cmo_fa_icons'] );
			}
		}
	}
