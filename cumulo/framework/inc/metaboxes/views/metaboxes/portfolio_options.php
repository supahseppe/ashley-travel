<ul class="cmo_metabox_tabs">
	<li class="active"><a href="#post"><?php echo __( "Portfolio", 'cumulo' ) ?></a></li>
	<li><a href="#header"><?php echo __( "Header", 'cumulo' ) ?></a></li>
...
<div class='cmo_metabox'>
	<div class="cmo_metabox_tab active" id="cmo_tab_post">
		<?php
		$this->select ( 'portfolio_style', __ ( 'Portfolio Style', 'cumulo' ), array (
		...
		), __ ( 'Select style of portfolio page.', 'cumulo' ) );
		?>
		<?php
		$this->select ( 'featured_image_masonry_size', __ ( 'Masonry Image Size', 'cumulo' ), array (
				'x_x' => __ ( 'X * X', 'cumulo' ),
				'x_dx' => __ ( 'X * 2X', 'cumulo' ),
				'dx_x' => __ ( '2X * X', 'cumulo' ),
				'dx_dx' => __ ( '2X * 2X', 'cumulo' ) 
		), __ ( 'Select featured image size in masonry layout.', 'cumulo' ) );
		?>
		<?php
		$this->text ( 'portfolio_client', __ ( 'Client', 'cumulo' ), __ ( 'Enter the name of the client personnel or company. Leave empty to hide.', 'cumulo' ) );
		?>
		<?php
		$this->text ( 'portfolio_duration', __ ( 'Duration', 'cumulo' ), __ ( 'Enter the duration of project. Leave empty to hide.', 'cumulo' ) );
		?>
		<?php
		$this->text ( 'portfolio_type', __ ( 'Type', 'cumulo' ), __ ( 'Enter the type of product. Leave empty to hide.', 'cumulo' ) );
		?>
		<?php
		$this->text ( 'portfolio_demo', __ ( 'Demo Link', 'cumulo' ), __ ( 'Enter the demo link of the project. Leave empty to hide.', 'cumulo' ) );
		?>
		<?php
		$this->select ( 'portfolio_show_related', __ ( 'Show Related Portfolios', 'cumulo' ), array (
				'yes' => __ ( 'Yes', 'cumulo' ),
				'no' => __ ( 'No', 'cumulo' ) 
		), __ ( 'Choose to display or hide related portfolios.', 'cumulo' ) );
		?>
	</div>
