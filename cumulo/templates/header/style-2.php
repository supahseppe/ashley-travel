...
$header_background_image = cmo_get_page_theme_option( 'header_background_image', 'header-background-image', "" );
if ( empty( $header_background_image ) ) {
	$header_background_image = cmo_get_absolute_url ( "assets/images/header-bg.jpg" );
}
...
<header id="cmo-header" class="<?php echo "header-" . esc_attr( $header_style ); ?> <?php if ( $slider_nav ) echo "slider-nav"; ?> <?php if ( $enable_sticky ) echo "enable-sticky"; ?>" style="background-image: url('<?php echo esc_url( $header_background_image ); ?>'); <?php 
$header_bg_repeat = cmo_get_page_theme_option( "header_background_repeat", "header-background-repeat" );
if ( $header_bg_repeat == "cover" ) {
	echo "background-size: cover;";
}
else {
	echo "background-repeat: " . esc_attr( $header_bg_repeat ) . ";";
}
?>">
