...
<header id="cmo-header" class="<?php echo "header-" . esc_attr( $header_style ); ?> <?php if ( $slider_nav ) echo "slider-nav"; ?> <?php if ( $enable_sticky ) echo "enable-sticky"; ?>">
	...
	<div id="header-info-bar">
		<div class="container">
			<?php if ( $topbar_email ) { ?>
			<span class="info-email"><span class="info-before">Email Us: </span><span><?php echo esc_html( $topbar_email ); ?></span></span>
			<?php } ?>
			<?php if ( $topbar_phone ) { ?>
			<span class="info-phone"><span class="info-before">Call Us: </span><span><?php echo esc_html( $topbar_phone ) ?></span></span>
			<?php } ?>
		</div>
	</div>
	<?php } ?>
