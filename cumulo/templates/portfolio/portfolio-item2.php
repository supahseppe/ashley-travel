...
?>
<article id="<?php the_ID()?>" <?php post_class( array( "cmo-portfolio-item", "cmo-post-in-list" ) ) ?>>
	<div class="cmo-portfolio-featured-image-wrapper">
		<div class="cmo-portfolio-featured-image-bg">
			<img src="<?php echo esc_url( $cmo_featured_image ) ?>" alt="Portfolio Image" />
